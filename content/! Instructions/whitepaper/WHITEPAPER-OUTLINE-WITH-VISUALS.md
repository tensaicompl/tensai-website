# WHITEPAPER OUTLINE WITH VISUAL PLACEMENT MARKERS
...
**Visual plan:** 59 visual elements. See VISUAL-CATALOG.md for full specifications. Markers below indicate exact placement.
...
[VIS-04: The Adoption-Impact Matrix]

[VIS-05: "88% adopt. 5.5% see impact."]
...
[VIS-06: Failure-Rate Convergence Table]

[VIS-10: "80--95% of AI projects fail. The technology works. The organisations do not."]
...
[VIS-07: BCG Three-Tier Segmentation]
...
[VIS-08: Regional Comparison Table]
...
[VIS-09: Agentic Readiness Assessment (Preliminary)]
...
[VIS-23: The Klarna Lesson (Case Study Card)] *(sidebar alongside Section 3.5)*
...
[VIS-59: Penalty Comparison Table (EU AI Act vs GDPR)]
...
| Chapter | Visual Markers | Count |
|---------|---------------|-------|
| Executive Summary | VIS-01, VIS-02, VIS-03 | 3 |
| Chapter 1 | VIS-04, VIS-05, VIS-06, VIS-07, VIS-08, VIS-09, VIS-10 | 7 |
| Chapter 2 | VIS-11, VIS-12, VIS-13, VIS-14, VIS-15, VIS-16, VIS-17 | 7 |
| Chapter 3 | VIS-18, VIS-19, VIS-20, VIS-21, VIS-22, VIS-23 | 6 |
| Chapter 4 | VIS-24, VIS-25, VIS-26, VIS-27, VIS-28, VIS-29, VIS-30 | 7 |
| Chapter 5 | VIS-31, VIS-32, VIS-33, VIS-34, VIS-35 | 5 |
| Chapter 6 | VIS-36, VIS-37, VIS-38, VIS-39, VIS-40, VIS-41 | 6 |
| Chapter 7 | VIS-42, VIS-43, VIS-44, VIS-45, VIS-46, VIS-47 | 6 |
| Chapter 8 | VIS-48, VIS-49, VIS-50, VIS-51, VIS-52 | 5 |
| Chapter 9 | VIS-53, VIS-54 | 2 |
| Chapter 10 | VIS-55, VIS-56, VIS-57, VIS-58 | 4 |
| Appendices | VIS-59 | 1 |
| **Total** | | **59** |
...
- When writing a section, check for `[VIS-XX: Title]` markers in this outline
- Leave the marker in place as a placeholder -- the design team will replace it with the produced visual
- Write the surrounding text to reference the visual naturally (e.g., "As the Adoption-Impact Matrix in Figure X shows...")
- Do not repeat the visual's content in prose -- let the visual carry the data, and use the text to interpret it
- Pull-quote cards (`[VIS-XX: "Quote text"]`) should appear as visual breaks between sections, not within a section's flow
