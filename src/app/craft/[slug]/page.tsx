...
export async function generateStaticParams() {
  return getConceptsByPillar("craft").map((c) => ({ slug: c.slug }));
}
...
export async function generateMetadata({
  ...
  const concept = getConceptBySlug("craft", slug);
  if (!concept) return {};
  return {
    title: `${concept.frontmatter.title} — The Craft — TensAI`,
    description: concept.frontmatter.definition,
  };
}

export default async function CraftConceptPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  const allConcepts = getConceptsByPillar("craft");
        ...
        >
          ...
          <nav aria-label="Breadcrumb">
            <div className="breadcrumb">
              ...
              <Link href="/craft" className="breadcrumb-link">
                The Craft
              </Link>
              <span className="breadcrumb-sep" aria-hidden="true">
                /
